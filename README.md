# Hand Writing BCI project for Computational Neurosceince  
Reimplementation of Willet et. al 2021  

**Contents:**  
_Time Warping_
1. single_letter_time_warping.ipynb: code written for time warp neural cubes for each letter

_PCA and Time Warped PCA_
1. PCA_Comp_Neuro_BCI.ipynb: code written for PCA and time warped PCA visualizations
