%% 
% This decoding example was downloaded directly from the authors' GitHub
% link. The only changes that I made were in the first and last section, where I
% loaded our own time warped data (4/30/25), 
% edited the for loop to plot the decoded traces for all of the characters, 
% and adjusted the layout so that they don't overlap with each other. 
...
warpedCube = load('/Users/deliadu/Desktop/BCI Group Project/t5.2019.05.08_warpedCubes_4_30.mat');
mouseTemplates = load('/Users/deliadu/Desktop/BCI Group Project/handwritingBCIData/Datasets/computerMouseTemplates.mat');
...
%%
%plot letters
[cY, cX] = meshgrid(1:8,1:8); % made a larger grid
cY = -cY;

figure('Position',[680 218 1024 880]);
hold on;

for c=1:length(letters) % for loop over all 31 characters
    ...
    text(cn(1), cn(2)+0.3, letters{c},'FontSize',15,'FontWeight','bold');
end
